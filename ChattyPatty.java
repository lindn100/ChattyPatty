 ...
 * responses.txt file.
 * Author: Jonathon Kwisses
 * Modified by Ryan Lindner + Antoine Canaan
 * to make ChattyPatty
 */
...
class ChattyPatty {
  ...
  private static String userInput;
    ...
    private static void displayMenu(boolean startup) {
        if(startup) {
            System.out.println("Type something to the chatbot.");
        }
        System.out.print("> ");
    }
    ...
    public static void setUserInput(String x) {
        userInput = x;
    ...
    public String getMessage()
    {
      ...
      response = getResponse(responsesArray, getUserInput());
      return response;
    }
    ...
    private static String getResponse(String[] responses, String userInput) {
        ...
        return "Speak up Dear! I don't understand what you are saying.";
    }
